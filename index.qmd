...
-   **Pull Request**: Propose edits or new sections by forking the [GitHub repository](https://github.com/SORTEE/start-your-codeclub-guide/tree/main) and submitting a `Pull Request`. For clarity and fast review, please describe the purpose of your change clearly in the PR description. Here you can see the repo structure:
...
-   **Open an issue**: Spot a typo, confusing parts, or missing topic? [Open an `issue`](https://github.com/SORTEE/start-your-codeclub-guide/issues) to discuss it before making changes, or to suggest new ideas and resources.
...
For more information and more ways to contribute, read [CONTRIBUTING](CONTRIBUTING.md)
